...
> **Note:** This directory contains early exploratory simulations created before the formal protocol specification was developed. These simulations are less rigorous and may not reflect the current protocol design, but are preserved for reference and their findings remain valuable.
>
> For current protocol implementations, see:
> - `../chain/` - Core chain primitives (refactored from `omerta_chain.py`)
