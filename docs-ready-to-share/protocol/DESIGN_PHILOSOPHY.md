...
**Future direction:** The protocol's formal semantics (labeled transition systems, relationship to multiparty session types) are documented in [FORMAL_SPECIFICATION.md](FORMAL_SPECIFICATION.md). Translation to TLA+ or Promela for model checking is identified as future work.
